...
from planercnn.data.datasets import load_scannet_json, load_arti_json
...
ARTI_SPLITS_OVERFIT = {
    ...
    "arti_val_overfit": ("arti", "v6_arti_RT_small/cached_set_val.json"),
    "arti_test_overfit": ("arti", "v6_arti_RT_small/cached_set_test.json"),
}
